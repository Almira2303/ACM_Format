...
\begin{figure}[h]
   \centering
    \includegraphics[width=0.40\textwidth]{figures_/framework.png}
...
\end{table}
   ...
   \begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{figures_/virgo_sample_query.jpg}
...
\begin{figure}[h]
   \centering
    \includegraphics[width=0.4\textwidth]{figures_/adalv4.jpg}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.4\textwidth]{figures_/RAG_bar_chart_result.png}
...
\begin{acks}
   ...
   We extend our deepest appreciation to \textbf{Rosel O. Onesa}, OIC Dean of the College of Computer Studies and our Thesis Adviser, for her invaluable guidance, recommendation and encouragement.
   
   We also thank \textbf{Allan Ibo Jr.}, our Consultant, for sharing his expertise and providing constructive insights for our systems and studies.

   Our gratitude goes to \textbf{Ma. Allaine C. Agna}, our Grammarian, for reviewing our manuscript and helping refine our writing.

   To \textbf{Joseph Jessie S. O\~nate}, our Panel Chairman, thank you for your thoughtful feedback, insights, and professional guidance during the evaluation of our study.

   We likewise extend our gratitude to \textbf{Tiffany Lyn O. Pandes}, one of our Panel Members and also our Subject Adviser, for her valuable comments, continuous support, reminders, and academic guidance that greatly assisted us throughout the semester, and to \textbf{Kaela Marie N. Fortuno}, our second Panel Member, for her helpful recommendations and encouragement that strengthened the overall outcome of this research.
